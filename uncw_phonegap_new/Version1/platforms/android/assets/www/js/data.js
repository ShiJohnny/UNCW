...
sensationApp.factory('Data', function(){
    ...
    data.items = [
        ...
        { 
            title: 'SGA',
            icon: 'university',
            page: 'http://student.uncw.edu/org/sga/'
        },
        { 
            title: 'Map',
            icon: 'map-marker',
        ...
        { 
            title: 'Seahawk',
            icon: 'trophy',
            page: 'http://www.uncwsports.com'
        },
        { 
            title: 'Library',
            icon: 'book',
            page: 'http://m.library.uncw.edu'
        },
        { 
            title: 'CampusRec',
            icon: 'soccer-ball-o',
            page: 'http://uncw.edu/campusrec'
        },
        { 
            title: 'Movies',
            icon: 'film',
        ...
        { 
            title: 'Dining',
            icon: 'cutlery',
            page: 'https://m.facebook.com/uncwcampusdining'
        },
        { 
            title: 'Health',
            icon: 'heartbeat',
            page: 'http://uncw.edu/healthservices/shc_hours.htm'
        }
...
sensationApp.factory('FeedData', function(){
    ...
    var data = { url: 'https://events.uncw.edu/MasterCalendar/RSSFeeds.aspx?data=mL1noRCrG1I%2fLTuo7OuVK%2b3TjVJzC2v3%2fDZnNcR1uMc%3d' };
