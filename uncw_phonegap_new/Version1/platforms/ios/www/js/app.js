...
(function() {
    ...
    app.controller('HomeController', function($scope, Data) {
        ...
        $scope.showDetail = function(index){
            ...
            // Add condition to check for http in the selectedItem.page string
            // if it has http then use the inAppBrowser to load the external URL
            // if selectedItem.page contains http 
             var isExternal = selectedItem.page.indexOf('http');
             if (isExternal > -1) {
                window.open(selectedItem.page, '_blank');     
             } else {
...
// Library: Libary Controller
    app.controller('LibraryController', function($scope, $http, AboutData) {
